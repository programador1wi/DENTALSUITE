...
export const excelReportDefinitions: ExcelReportDefinition[] = [
  enabled(
    ...
    "Agenda",
    "Citas, cancelaciones, no asistencias y ocupacion por profesional.",
    "AGENDA",
    "appointments",
    branchDateRange,
    "reports.read",
    ["citas", "agenda", "ocupacion"]
  ),
  enabled(
  ...
  enabled(
    "PATIENTS_SUMMARY",
    "Pacientes",
    "Pacientes nuevos, activos, sin cita futura y fuentes de captacion.",
    "PACIENTES",
    "patients",
    branchDateRange,
    "reports.read",
  ...
  enabled(
    "TREATMENTS_SUMMARY",
    "Tratamientos",
    "Planes creados, aceptados, en progreso y finalizados.",
    "TRATAMIENTOS",
    "treatments",
    branchDateRange,
    "reports.read",
  ...
  enabled(
    ...
    [
      ...
      { key: "cashRegisterId", label: "Caja", type: "select", dependsOn: "branchId" },
      {
        ...
        label: "Estado",
        type: "select",
        options: [{ label: "Todos", value: "ALL" }, ...paymentStatusOptions]
      }
    ],
    "reports.read",
  ...
  enabled(
    ...
    "Profesionales",
    "Productividad, agenda, cancelaciones y laboratorio pendiente.",
    "USUARIOS",
    "professionals",
    branchDateRange,
    "reports.read",
    ["profesionales", "productividad"]
  ),
  enabled(
    "USERS_LIST",
    "Listado usuarios",
  ...
  disabled(
    ...
    "Citas cuyo estado haya sido alguno de los disponibles",
    "Citas filtradas por uno o varios estados.",
    "AGENDA"
  ),
  disabled(
    "PROFESSIONAL_BLOCKED_HOURS",
    "Horas bloqueadas en profesionales",
    "Bloqueos de agenda por profesional.",
    "AGENDA"
  ),
  disabled(
    "MONTHLY_PATIENT_APPOINTMENT_STATUSES",
    "Estados de citas de pacientes en mes especifico",
    "Estados mensuales de citas de pacientes.",
    "AGENDA"
  ),
  disabled(
    "CAPACITY_OCCUPANCY",
    "Cupos y ocupacion",
    "Cupos disponibles y ocupacion por sucursal/profesional.",
    "AGENDA"
  ),
  disabled(
    "APPOINTMENTS_DIAGNOSIS_TREATMENT",
    "Citas, sus estados y si son de diagnostico o tratamiento",
    "Detalle de citas clasificadas por diagnostico/tratamiento.",
    "AGENDA"
  ),
  disabled(
    "BRANCH_APPOINTMENT_STATUSES",
    "Estados de citas por sucursal y rango de fechas",
    "Resumen de estados por sucursal.",
    "AGENDA"
  ),
  disabled(
    "PROFESSIONAL_STATUS_SUMMARY",
    "Resumen de estados por profesional entre dos fechas",
    "Resumen por profesional y estado.",
    "AGENDA"
  ),
  disabled(
    "APPOINTMENTS_IN_RANGE",
    "Citas agendadas dentro de un rango",
    "Citas agendadas por rango de fechas.",
    "AGENDA"
  ),
  disabled(
    "ONLINE_CAMPAIGN_APPOINTMENTS",
    "Citas online por campanas",
    "Citas generadas desde campanas online.",
    "AGENDA"
  ),
  ...
  disabled(
    ...
    "Plantillas de arancel configuradas.",
    "LISTADO DE PRECIOS"
  ),
  disabled("AGREEMENTS_LIST", "Listado de convenios", "Convenios registrados.", "CONVENIOS"),
  disabled(
    "CRM_TASKS_PERIOD",
    "Tareas de gestion generadas en un periodo",
    "Tareas CRM generadas por periodo.",
    "CRM"
  ),
  disabled("CRM_TASKS_DUE", "Tareas de gestion por vencer", "Tareas CRM proximas a vencer.", "CRM"),
  disabled(
    "SATISFACTION_SURVEY_RESPONSES",
    "Respuestas de encuestas de satisfaccion",
    "Respuestas de encuestas registradas.",
    "CRM"
  ),
  disabled(
    "REFUND_REQUESTS",
    "Solicitudes de reembolso",
    "Solicitudes de reembolso registradas.",
    "FINANZAS"
  ),
  disabled(
    "AGREEMENT_BUDGET_PAYMENT_STATUS",
    "Estado de pagos de presupuestos por convenio",
    "Estado de pagos por convenio.",
    "FINANZAS"
  ),
  disabled(
    "PAYMENTS_BY_ACTION_DETAIL",
    "Pagos pacientes, detalle por accion",
    "Pagos por accion clinica.",
    "FINANZAS"
  ),
  disabled(
    "PAYMENTS_BY_DUE_DATE",
    "Pagos por fecha de vencimiento",
    "Pagos agrupados por vencimiento.",
    "FINANZAS"
  ),
  disabled(
    "PAYMENTS_BY_DUE_DATE_CURRENT",
    "Pagos por fecha de vencimiento incluyendo pagos al dia",
    "Pagos vencidos y al dia.",
    "FINANZAS"
  ),
  ...
  disabled(
    ...
    "Pagos vinculados a financiamientos.",
    "FINANZAS"
  ),
  disabled(
    "PAYROLL_DISCOUNT_PAYMENTS",
    "Pagos por descuento de planilla",
    "Pagos por descuento de planilla.",
    "FINANZAS"
  ),
  disabled(
    "PAYMENTS_WITHOUT_RECEIPT",
    "Pagos sin comprobante asociado",
  ...
  enabled(
    "CASH_FLOW",
    "Flujo de caja",
    "Saldo inicial, ingresos, gastos, devoluciones, ajustes y cierres por periodo.",
    "FINANZAS",
    "cash-flow",
    branchDateRange,
    "reports.read",
    ["caja", "flujo", "movimientos", "cierres"]
  ),
  disabled(
    "OPERATIONAL_INCOME_STATEMENT",
  ...
  enabled(
    "EXPENSE_DETAIL",
    "Detalle de gastos",
    "Gastos por categoria, sucursal, caja, medio de pago y estado.",
    "FINANZAS",
    "expense-detail",
    branchDateRange,
    "reports.read",
    ["gastos", "egresos", "categorias"]
  ),
  disabled(
    "PAYROLL_COLLECTION_REPORTS",
    "Informes de cobranza por planilla",
    "Cobranza por descuento de planilla.",
    "FINANZAS"
  ),
  ...
  disabled(
    "LAB_REQUESTS_IN_PROCESS",
    "Solicitudes en proceso",
    "Solicitudes de laboratorio en proceso.",
    "LABORATORIOS"
  ),
  disabled(
    "LAB_REQUESTS_IN_REVIEW",
    "Solicitudes en revision",
    "Solicitudes de laboratorio en revision.",
    "LABORATORIOS"
  ),
  disabled(
    "LAB_COMPLETED_UNPAID",
    "Solicitudes finalizadas no pagadas",
    "Solicitudes de laboratorio finalizadas pendientes de pago.",
    "LABORATORIOS"
  ),
  disabled(
    "LAB_ALL_REQUESTS",
  ...
  disabled(
    "LAB_TOP_ACTIONS",
    "Acciones de laboratorio mas solicitadas",
    "Ranking de acciones de laboratorio.",
    "LABORATORIOS"
  ),
  disabled(
    "LAB_PRICE_VS_COST",
    "Precio de acciones versus costo de laboratorio",
    "Comparacion precio/costo laboratorio.",
    "LABORATORIOS"
  ),
  disabled("LAB_MARGIN", "Margen de ganancias", "Margen de ganancia de laboratorio.", "LABORATORIOS"),
  disabled(
    "FINALIZED_PAYROLL_LIQUIDATIONS",
    "Liquidaciones finalizadas",
    "Liquidaciones finalizadas de nomina.",
    "NOMINAS"
  ),
  ...
  disabled(
    ...
    "Seguimiento operacional de pacientes.",
    "PACIENTES"
  ),
  ...
  disabled(
    ...
    "Pacientes con odontograma registrado.",
    "PACIENTES"
  ),
  disabled(
  ...
  disabled(
    ...
    "Consentimientos informados generados.",
    "PACIENTES"
  ),
  disabled(
    "NEW_PATIENTS_REGISTERED",
    "Pacientes nuevos registrados entre fechas",
    "Pacientes creados entre fechas.",
    "PACIENTES"
  ),
  disabled(
    "NEW_PATIENTS_FIRST_APPOINTMENT",
    "Pacientes nuevos segun primera cita",
    "Pacientes nuevos por primera cita.",
    "PACIENTES"
  ),
  disabled(
    "NEW_PATIENTS_ONLINE",
    "Pacientes nuevos desde Agenda Online",
    "Pacientes captados desde agenda online.",
    "PACIENTES"
  ),
  disabled(
    "NEW_PATIENTS_FIRST_PROFESSIONAL",
    "Pacientes nuevos por primer profesional",
    "Pacientes nuevos por primer profesional.",
    "PACIENTES"
  ),
  disabled(
    "DELINQUENT_PATIENTS_FINANCING",
    "Pacientes morosos por financiamiento",
    "Mora por financiamiento.",
    "PACIENTES"
  ),
  disabled(
    "PATIENT_EVOLUTIONS",
    "Evoluciones de pacientes",
    "Evoluciones clinicas de pacientes.",
    "PACIENTES"
  ),
  disabled(
    "PATIENTS_TREATED_BY_PROFESSIONAL",
    "Pacientes tratados por un profesional",
  ...
  disabled(
    ...
    "Pacientes sin tratamiento o baja actividad.",
    "PACIENTES"
  ),
  disabled(
    "UNREALIZED_PROCEDURES",
    "Prestaciones desrealizadas",
    "Prestaciones revertidas o desrealizadas.",
    "TRATAMIENTOS"
  ),
  disabled("BALANCE_SUMMARY", "Resumen de saldos", "Resumen de saldos de tratamientos.", "TRATAMIENTOS"),
  disabled(
    "ACTIONS_PERFORMED_PERIOD",
    "Acciones realizadas en un periodo",
    "Acciones realizadas en rango.",
    "TRATAMIENTOS"
  ),
  disabled(
    "FINALIZED_TREATMENT_PLANS",
    "Planes de tratamiento finalizados",
    "Planes finalizados.",
    "TRATAMIENTOS"
  ),
  disabled(
    "BUDGET_STATUS_BY_ACTION",
    "Estado de presupuestos por accion",
    "Estado de presupuestos por accion.",
    "TRATAMIENTOS"
  ),
  disabled(
    "GENERATED_BUDGET_STATUS",
    "Estado de presupuestos generados",
    "Estado de presupuestos generados.",
    "TRATAMIENTOS"
  ),
  disabled(
    "UNFINISHED_PLANS_NO_FUTURE_APPOINTMENTS",
    "Planes no finalizados sin citas futuras",
    "Planes activos sin futuras citas.",
    "TRATAMIENTOS"
  ),
  disabled(
    "PAID_NOT_PERFORMED_ACTIONS",
    "Acciones pagadas pero no realizadas",
