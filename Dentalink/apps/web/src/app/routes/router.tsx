...
const AgendaViewPage = lazy(() =>
  import("@/features/agenda/pages/agenda-view-page").then((m) => ({ default: m.AgendaViewPage }))
);
const AgendaPrintPage = lazy(() =>
  import("@/features/agenda/pages/agenda-print-page").then((m) => ({ default: m.AgendaPrintPage }))
);
const ReprogrammingPage = lazy(() =>
  import("@/features/agenda/pages/reprogramming-page").then((m) => ({ default: m.ReprogrammingPage }))
);
const AppointmentRemindersPage = lazy(() =>
  import("@/features/agenda/pages/appointment-reminders-page").then((m) => ({
    default: m.AppointmentRemindersPage
  }))
);
const LoginPage = lazy(() =>
  import("@/features/auth/pages/login-page").then((m) => ({ default: m.LoginPage }))
);
const ClinicalDocumentsPage = lazy(() =>
  import("@/features/clinical/pages/clinical-documents-page").then((m) => ({
    default: m.ClinicalDocumentsPage
  }))
);
const ClinicalEvolutionsPage = lazy(() =>
  import("@/features/clinical/pages/clinical-evolutions-page").then((m) => ({
    default: m.ClinicalEvolutionsPage
  }))
);
const ClinicalHistoryPage = lazy(() =>
  import("@/features/clinical/pages/clinical-history-page").then((m) => ({ default: m.ClinicalHistoryPage }))
);
const ClinicalMedicalHistoryPage = lazy(() =>
  import("@/features/clinical/pages/clinical-medical-history-page").then((m) => ({
    default: m.ClinicalMedicalHistoryPage
  }))
);
const ClinicalOdontogramPage = lazy(() =>
  import("@/features/clinical/pages/clinical-odontogram-page").then((m) => ({
    default: m.ClinicalOdontogramPage
  }))
);
const ClinicalPeriodontogramPage = lazy(() =>
  import("@/features/clinical/pages/clinical-periodontogram-page").then((m) => ({
    default: m.ClinicalPeriodontogramPage
  }))
);
const ClinicalPrescriptionsPage = lazy(() =>
  import("@/features/clinical/pages/clinical-prescriptions-page").then((m) => ({
    default: m.ClinicalPrescriptionsPage
  }))
);
const CollectionDetailPage = lazy(() =>
  import("@/features/collections/pages/collection-detail-page").then((m) => ({
    default: m.CollectionDetailPage
  }))
);
const CollectionsPage = lazy(() =>
  import("@/features/collections/pages/collections-page").then((m) => ({ default: m.CollectionsPage }))
);
const DashboardPage = lazy(() =>
  import("@/features/dashboard/pages/dashboard-page").then((m) => ({ default: m.DashboardPage }))
);
const HealthCenterPage = lazy(() =>
  import("@/features/health-center/pages/health-center-page").then((m) => ({ default: m.HealthCenterPage }))
);
const InventoryMovementsPage = lazy(() =>
  import("@/features/labs-inventory/pages/inventory-movements-page").then((m) => ({
    default: m.InventoryMovementsPage
  }))
);
const InventoryPage = lazy(() =>
  import("@/features/labs-inventory/pages/inventory-page").then((m) => ({ default: m.InventoryPage }))
);
const LabOrdersPage = lazy(() =>
  import("@/features/labs-inventory/pages/lab-orders-page").then((m) => ({ default: m.LabOrdersPage }))
);
const LabProceduresPage = lazy(() =>
  import("@/features/labs-inventory/pages/lab-procedures-page").then((m) => ({
    default: m.LabProceduresPage
  }))
);
const LabsPage = lazy(() =>
  import("@/features/labs-inventory/pages/labs-page").then((m) => ({ default: m.LabsPage }))
);
const IntegrationsPage = lazy(() =>
  import("@/features/integrations/pages/integrations-page").then((m) => ({ default: m.IntegrationsPage }))
);
const EmailMarketingPage = lazy(() =>
  import("@/features/email-marketing/pages/email-marketing-page").then((m) => ({
    default: m.EmailMarketingPage
  }))
);
const SurveyManagementPage = lazy(() =>
  import("@/features/surveys/pages/survey-management-page").then((m) => ({ default: m.SurveyManagementPage }))
);
const PublicSurveyPage = lazy(() =>
  import("@/features/surveys/pages/public-survey-page").then((m) => ({ default: m.PublicSurveyPage }))
);
...
const ReportsChartsPage = lazy(() =>
  import("@/features/reports/pages/reports-charts-page").then((m) => ({ default: m.ReportsChartsPage }))
);
const ReportsExcelPage = lazy(() =>
  import("@/features/reports/pages/reports-excel-page").then((m) => ({ default: m.ReportsExcelPage }))
);
const ReportsFinancialPage = lazy(() =>
  import("@/features/reports/pages/reports-financial-page").then((m) => ({ default: m.ReportsFinancialPage }))
);
const ReportsPage = lazy(() =>
  import("@/features/reports/pages/reports-page").then((m) => ({ default: m.ReportsPage }))
);
const ReportsPatientsPage = lazy(() =>
  import("@/features/reports/pages/reports-patients-page").then((m) => ({ default: m.ReportsPatientsPage }))
);
const ReportsPerformancePage = lazy(() =>
  import("@/features/reports/pages/reports-performance-page").then((m) => ({
    default: m.ReportsPerformancePage
  }))
);
const ReportsProfessionalsPage = lazy(() =>
  import("@/features/reports/pages/reports-professionals-page").then((m) => ({
    default: m.ReportsProfessionalsPage
  }))
);
const ReportsTreatmentsPage = lazy(() =>
  import("@/features/reports/pages/reports-treatments-page").then((m) => ({
    default: m.ReportsTreatmentsPage
  }))
);
const ConsentTemplatesSettingsPage = lazy(() =>
  import("@/features/settings/consent-templates/pages/consent-templates-settings-page").then((m) => ({
    default: m.ConsentTemplatesSettingsPage
  }))
);
const ProfilePage = lazy(() =>
  import("@/features/settings/profile/pages/profile-page").then((m) => ({ default: m.ProfilePage }))
);
const NovedadesPage = lazy(() => import("@/features/novedades").then((m) => ({ default: m.NovedadesPage })));
const UsersPage = lazy(() =>
  import("@/features/settings/users/pages/users-page").then((m) => ({ default: m.UsersPage }))
);
const AccessUsersBlockPage = lazy(() =>
  import("@/features/settings/users/pages/users-blocks-page").then((m) => ({
    default: m.AccessUsersBlockPage
  }))
);
const AgendaUsersBlockPage = lazy(() =>
  import("@/features/settings/users/pages/users-blocks-page").then((m) => ({
    default: m.AgendaUsersBlockPage
  }))
);
const UsersBulkContractsPage = lazy(() =>
  import("@/features/settings/users/pages/users-bulk-contracts-page").then((m) => ({
    default: m.UsersBulkContractsPage
  }))
);
const RolesPage = lazy(() =>
  import("@/features/settings/roles/pages/roles-page").then((m) => ({ default: m.RolesPage }))
);
const RoleDetailPage = lazy(() =>
  import("@/features/settings/roles/pages/role-detail-page").then((m) => ({ default: m.RoleDetailPage }))
);
const OrganizationSettingsPage = lazy(() =>
  import("@/features/settings/organization/pages/organization-settings-page").then((m) => ({
    default: m.OrganizationSettingsPage
  }))
);
const OrganizationLogoSettingsPage = lazy(() =>
  import("@/features/settings/organization/pages/organization-logo-settings-page").then((m) => ({
    default: m.OrganizationLogoSettingsPage
  }))
);
const BranchesSettingsPage = lazy(() =>
  import("@/features/settings/branches/pages/branches-settings-page").then((m) => ({
    default: m.BranchesSettingsPage
  }))
);
const SpecialtiesSettingsPage = lazy(() =>
  import("@/features/settings/specialties/pages/specialties-settings-page").then((m) => ({
    default: m.SpecialtiesSettingsPage
  }))
);
const AgendaOnlineTab = lazy(() =>
  import("@/features/settings/online-scheduling/pages/agenda-online-tab").then((m) => ({
    default: m.AgendaOnlineTab
  }))
);
const AgendaExpressTab = lazy(() =>
  import("@/features/settings/online-scheduling/pages/agenda-express-tab").then((m) => ({
    default: m.AgendaExpressTab
  }))
);
const OnlineSchedulesTab = lazy(() =>
  import("@/features/settings/online-scheduling/pages/online-schedules-tab").then((m) => ({
    default: m.OnlineSchedulesTab
  }))
);
const CampaignsTab = lazy(() =>
  import("@/features/settings/online-scheduling/pages/campaigns-tab").then((m) => ({
    default: m.CampaignsTab
  }))
);
const DashboardTab = lazy(() =>
  import("@/features/settings/online-scheduling/pages/dashboard-tab").then((m) => ({
    default: m.DashboardTab
  }))
);
const ChairsSettingsPage = lazy(() =>
  import("@/features/settings/chairs/pages/chairs-settings-page").then((m) => ({
    default: m.ChairsSettingsPage
  }))
);
const PaymentMethodsSettingsPage = lazy(() =>
  import("@/features/settings/payment-methods/pages/payment-methods-settings-page").then((m) => ({
    default: m.PaymentMethodsSettingsPage
  }))
);
const ProceduresSettingsPage = lazy(() =>
  import("@/features/settings/procedures/pages/procedures-settings-page").then((m) => ({
    default: m.ProceduresSettingsPage
  }))
);
const PriceListsSettingsPage = lazy(() =>
  import("@/features/settings/price-lists/pages/price-lists-settings-page").then((m) => ({
    default: m.PriceListsSettingsPage
  }))
);
const FinancialInstitutionsSettingsPage = lazy(() =>
  import("@/features/settings/financial-institutions/pages/financial-institutions-settings-page").then(
    (m) => ({ default: m.FinancialInstitutionsSettingsPage })
  )
);
const ClinicalDocumentTemplatesSettingsPage = lazy(() =>
  import("@/features/settings/clinical-document-templates/pages/clinical-document-templates-settings-page").then(
    (m) => ({ default: m.ClinicalDocumentTemplatesSettingsPage })
  )
);
const AgreementsSettingsPage = lazy(() =>
  import("@/features/settings/admin-workflows/pages/agreements-settings-page").then((m) => ({
    default: m.AgreementsSettingsPage
  }))
);
const ExpensesSettingsPage = lazy(() =>
  import("@/features/settings/admin-workflows/pages/expenses-settings-page").then((m) => ({
    default: m.ExpensesSettingsPage
  }))
);
const PayrollSettingsPage = lazy(() =>
  import("@/features/settings/admin-workflows/pages/payroll-settings-page").then((m) => ({
    default: m.PayrollSettingsPage
  }))
);
const PlansServicesSettingsPage = lazy(() =>
  import("@/features/settings/admin-workflows/pages/plans-services-settings-page").then((m) => ({
    default: m.PlansServicesSettingsPage
  }))
);
const ApiKeysSettingsPage = lazy(() =>
  import("@/features/settings/api-keys/pages/api-keys-settings-page").then((m) => ({
    default: m.ApiKeysSettingsPage
  }))
);
const ApiKeyFormPage = lazy(() =>
  import("@/features/settings/api-keys/pages/api-key-form-page").then((m) => ({ default: m.ApiKeyFormPage }))
);
const PatientClinicalPage = lazy(() =>
  import("@/features/patients/pages/patient-clinical-page").then((m) => ({ default: m.PatientClinicalPage }))
);
const PatientConsentsPage = lazy(() =>
  import("@/features/patients/pages/patient-consents-page").then((m) => ({ default: m.PatientConsentsPage }))
);
const PatientDetailPage = lazy(() =>
  import("@/features/patients/pages/patient-detail-page").then((m) => ({ default: m.PatientDetailPage }))
);
const PatientFilesPage = lazy(() =>
  import("@/features/patients/pages/patient-files-page").then((m) => ({ default: m.PatientFilesPage }))
);
const PatientNewPage = lazy(() =>
  import("@/features/patients/pages/patient-new-page").then((m) => ({ default: m.PatientNewPage }))
);
const PatientMergePage = lazy(() =>
  import("@/features/patients/pages/patient-merge-page").then((m) => ({ default: m.PatientMergePage }))
);
const PatientIdentityQualityPage = lazy(() =>
  import("@/features/patients/pages/patient-identity-quality-page").then((m) => ({
    default: m.PatientIdentityQualityPage
  }))
);
const PatientPaymentsPage = lazy(() =>
  import("@/features/patients/pages/patient-payments-page").then((m) => ({ default: m.PatientPaymentsPage }))
);
const PatientBillingLayout = lazy(() =>
  import("@/features/patients/pages/patient-billing-layout").then((m) => ({
    default: m.PatientBillingLayout
  }))
);
const PaymentsView = lazy(() =>
  import("@/features/patients/pages/billing-views/payments-view").then((m) => ({ default: m.PaymentsView }))
);
const IssuedDocumentsView = lazy(() =>
  import("@/features/patients/pages/billing-views/issued-documents-view").then((m) => ({
    default: m.IssuedDocumentsView
  }))
);
const CoverageLayout = lazy(() =>
  import("@/features/patients/pages/billing-views/coverages-view").then((m) => ({
    default: m.CoverageLayout
  }))
);
const OnlineBenefitsView = lazy(() =>
  import("@/features/patients/pages/billing-views/coverages-view").then((m) => ({
    default: m.OnlineBenefitsView
  }))
);
const ReimbursementRequestsView = lazy(() =>
  import("@/features/patients/pages/billing-views/coverages-view").then((m) => ({
    default: m.ReimbursementRequestsView
  }))
);
const RefundsView = lazy(() =>
  import("@/features/patients/pages/billing-views/refunds-view").then((m) => ({ default: m.RefundsView }))
);
const VoidedPaymentsView = lazy(() =>
  import("@/features/patients/pages/billing-views/voided-payments-view").then((m) => ({
    default: m.VoidedPaymentsView
  }))
);
const PatientBalanceView = lazy(() =>
  import("@/features/patients/pages/billing-views/patient-balance-view").then((m) => ({
    default: m.PatientBalanceView
  }))
);
const PatientProfilePage = lazy(() =>
  import("@/features/patients/pages/patient-profile-page").then((m) => ({ default: m.PatientProfilePage }))
);
const PatientTreatmentNewPage = lazy(() =>
  import("@/features/patients/pages/patient-treatment-new-page").then((m) => ({
    default: m.PatientTreatmentNewPage
  }))
);
const PatientTreatmentsPage = lazy(() =>
  import("@/features/patients/pages/patient-treatments-page").then((m) => ({
    default: m.PatientTreatmentsPage
  }))
);
const PatientsAnalysisPage = lazy(() =>
  import("@/features/patients/pages/patients-analysis-page").then((m) => ({
    default: m.PatientsAnalysisPage
  }))
);
const PatientsConfigurationPage = lazy(() =>
  import("@/features/patients/pages/patients-configuration-page").then((m) => ({
    default: m.PatientsConfigurationPage
  }))
);
const PatientsOrthodontiaPage = lazy(() =>
  import("@/features/patients/pages/patients-orthodontia-page").then((m) => ({
    default: m.PatientsOrthodontiaPage
  }))
);
const PatientsPage = lazy(() =>
  import("@/features/patients/pages/patients-page").then((m) => ({ default: m.PatientsPage }))
);
const CrmTasksLayout = lazy(() =>
  import("@/features/crm/tasks/components/crm-tasks-layout").then((m) => ({ default: m.CrmTasksLayout }))
);
const CrmTasksPage = lazy(() =>
  import("@/features/crm/tasks/pages/crm-tasks-page").then((m) => ({ default: m.CrmTasksPage }))
);
const CrmTasksStatisticsPage = lazy(() =>
  import("@/features/crm/tasks/pages/crm-tasks-statistics-page").then((m) => ({
    default: m.CrmTasksStatisticsPage
  }))
);
const CrmTasksConfigurationPage = lazy(() =>
  import("@/features/crm/tasks/pages/crm-tasks-configuration-page").then((m) => ({
    default: m.CrmTasksConfigurationPage
  }))
);
const AccountsReceivablePage = lazy(() =>
  import("@/features/payments/pages/accounts-receivable-page").then((m) => ({
    default: m.AccountsReceivablePage
  }))
);
const CashRegisterPage = lazy(() =>
  import("@/features/payments/pages/cash-register-page").then((m) => ({ default: m.CashRegisterPage }))
);
const CashRegisterDetailPage = lazy(() =>
  import("@/features/payments/pages/cash-register-detail-page").then((m) => ({
    default: m.CashRegisterDetailPage
  }))
);
const InstallmentsPage = lazy(() =>
  import("@/features/payments/pages/installments-page").then((m) => ({ default: m.InstallmentsPage }))
);
const PaymentsPage = lazy(() =>
  import("@/features/payments/pages/payments-page").then((m) => ({ default: m.PaymentsPage }))
);
const PaymentLinksPage = lazy(() =>
  import("@/features/payments/pages/payment-links-page").then((m) => ({ default: m.PaymentLinksPage }))
);
const CancelledPendingPaymentsPage = lazy(() =>
  import("@/features/payments/pages/cancelled-pending-payments-page").then((m) => ({
    default: m.CancelledPendingPaymentsPage
  }))
);
const PaymentSettlementsPage = lazy(() =>
  import("@/features/payments/pages/payment-settlements-page").then((m) => ({
    default: m.PaymentSettlementsPage
  }))
);
const PaymentDailyReceiptPage = lazy(() =>
  import("@/features/payments/pages/payment-daily-receipt-page").then((m) => ({
    default: m.PaymentDailyReceiptPage
  }))
);
const PaymentReceiptPage = lazy(() =>
  import("@/features/payments/pages/payment-receipt-page").then((m) => ({ default: m.PaymentReceiptPage }))
);
const BudgetsPage = lazy(() =>
  import("@/features/treatments/pages/budgets-page").then((m) => ({ default: m.BudgetsPage }))
);
const TreatmentPlansPage = lazy(() =>
  import("@/features/treatments/pages/treatment-plans-page").then((m) => ({ default: m.TreatmentPlansPage }))
);
const PublicBookingPage = lazy(() =>
  import("@/features/public-booking/pages/public-booking-page").then((m) => ({
    default: m.PublicBookingPage
  }))
);
const ConfirmAppointmentPage = lazy(() =>
  import("@/features/public-booking/pages/confirm-appointment-page").then((m) => ({
    default: m.ConfirmAppointmentPage
  }))
);
const CompletePatientProfilePage = lazy(() =>
  import("@/features/public-booking/pages/complete-patient-profile-page").then((m) => ({
    default: m.CompletePatientProfilePage
  }))
);
const MobilePhotographicUploadPage = lazy(() =>
  import("@/features/treatments/pages/mobile-photographic-upload-page").then((m) => ({
    default: m.MobilePhotographicUploadPage
  }))
);
...
function RouteLoadingFallback() {
  return (
    <div
      className="flex min-h-[60dvh] w-full min-w-0 items-center justify-center"
      role="status"
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 text-slate-900">
      <div className="text-center">
        ...
        <a
          href="/"
          className="inline-flex rounded-lg bg-[var(--action-primary)] px-6 py-3 font-semibold text-white hover:bg-[var(--action-primary-hover)] transition-colors"
        >
          Volver al inicio
        </a>
      </div>
...
function AppRouteErrorPage() {
  ...
  return (
    <main
      className="flex min-h-screen items-center justify-center bg-[var(--bg-subtle)] p-4"
      data-route-error
    >
      <section className="w-full max-w-lg rounded-[var(--radius-lg)] border border-[var(--border-default)] bg-[var(--bg-surface)] p-6 text-center shadow-[var(--shadow-card)]">
        ...
        <h1 className="mt-2 text-[var(--text-xl)] font-semibold text-[var(--text-primary)]">
...
function RedirectDynamicParam({
  builder
}: {
  builder: (params: Record<string, string | undefined>, search: string) => string;
}) {
...
export const router = createBrowserRouter([
  ...
  // Public Tokenized Routes
  {
    ...
    children: [
      ...
      {
        path: "/book/:slug",
        element: <RedirectDynamicParam builder={(p, s) => `/reservar/${p.slug ?? ""}${s}`} />
      },
      ...
      {
        path: "/mobile/photographic-upload/:token",
        element: <RedirectDynamicParam builder={(p, s) => `/movil/subida-fotos/${p.token ?? ""}${s}`} />
      },
      {
        path: "/public/surveys/respond/:token",
        element: (
          <RedirectDynamicParam builder={(p, s) => `/publico/encuestas/responder/${p.token ?? ""}${s}`} />
        )
      }
    ]
  },
        ...
        children: [
          {
            ...
            children: [
              ...
              // Legacy redirects
              {
                path: "/payments/:paymentNumber/receipt",
                element: (
                  <RedirectDynamicParam builder={(p, s) => `/pagos/${p.paymentNumber ?? ""}/recibo${s}`} />
                )
              },
              {
                path: "/patients/:id/payments/daily-receipt",
                element: (
                  <RedirectDynamicParam
                    builder={(p, s) => `/pacientes/${p.id ?? ""}/pagos/recibo-diario${s}`}
                  />
                )
              }
            ]
        ...
        children: [
          ...
          // Configuración general
          {
            ...
            children: [
              ...
              // Legacy settings redirects
              {
                ...
                element: <RedirectWithSearch to="/configuracion/organizacion" />
              },
              ...
              {
                path: "/settings/plans",
                element: <RedirectWithSearch to="/configuracion/planes-servicios" />
              }
            ]
          },
          {
            element: <RequirePermissions required={["developer_api.credentials.read"]} />,
            children: [
              { path: "/configuracion/credenciales-api", element: <ApiKeysSettingsPage /> },
              {
                path: "/settings/api-keys",
                element: <RedirectWithSearch to="/configuracion/credenciales-api" />
              }
            ]
          },
          {
            element: <RequirePermissions required={["developer_api.credentials.manage"]} />,
            children: [
              { path: "/configuracion/credenciales-api/nueva", element: <ApiKeyFormPage /> },
              { path: "/configuracion/credenciales-api/:id/editar", element: <ApiKeyFormPage /> }
            ]
          },
          {
            ...
            children: [
              {
                ...
                element: <Navigate to="/configuracion/usuarios?kind=CLINICAL" replace />
              },
              {
          ...
          },
          {
            ...
            children: [
              { path: "/configuracion/especialidades", element: <SpecialtiesSettingsPage /> },
              {
                ...
                element: <RedirectWithSearch to="/configuracion/especialidades" />
              }
            ]
          },
          {
            ...
            children: [
              ...
              {
                path: "/settings/online-scheduling",
                element: <RedirectWithSearch to="/configuracion/agenda-online" />
              },
              {
                path: "/settings/online-scheduling/express",
                element: <RedirectWithSearch to="/configuracion/agenda-online/express" />
              },
              {
                path: "/settings/schedules",
                element: <RedirectWithSearch to="/configuracion/agenda-online/horarios" />
              },
              {
                path: "/settings/online-scheduling/schedules",
                element: <RedirectWithSearch to="/configuracion/agenda-online/horarios" />
              },
              {
                path: "/settings/online-scheduling/campaigns",
                element: <RedirectWithSearch to="/configuracion/agenda-online/campanas" />
              },
              {
                path: "/settings/online-scheduling/dashboard",
                element: <RedirectWithSearch to="/configuracion/agenda-online/panel" />
              }
            ]
          },
          {
          ...
          },
          {
            ...
            children: [
              { path: "/configuracion/medios-pago", element: <PaymentMethodsSettingsPage /> },
              {
                ...
                element: <RedirectWithSearch to="/configuracion/medios-pago" />
              }
            ]
          },
          {
            ...
            children: [
              { path: "/configuracion/procedimientos", element: <ProceduresSettingsPage /> },
              {
                ...
                element: <RedirectWithSearch to="/configuracion/procedimientos" />
              }
            ]
          },
          {
            ...
            children: [
              ...
              {
                path: "/configuracion/listas-precios/categorias/:categoryId",
                element: <PriceListsSettingsPage />
              },
              {
                path: "/configuracion/listas-precios/categories/:categoryId",
                element: (
                  <RedirectDynamicParam
                    builder={(p, s) => `${APP_ROUTES.settings.priceListCategory(p.categoryId ?? "")}${s}`}
                  />
                )
              },
              ...
              // Legacy price-list redirects
              {
                ...
                element: <RedirectWithSearch to="/configuracion/listas-precios" />
              },
              {
                path: "/settings/price-lists/categories/:categoryId",
                element: (
                  <RedirectDynamicParam
                    builder={(p, s) => `/configuracion/listas-precios/categorias/${p.categoryId ?? ""}${s}`}
                  />
                )
              }
            ]
          },
          {
            ...
            children: [
              { path: "/configuracion/plantillas-consentimiento", element: <ConsentTemplatesSettingsPage /> },
              {
                ...
                element: <RedirectWithSearch to="/configuracion/plantillas-consentimiento" />
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "/configuracion/documentos-clinicos",
                element: <ClinicalDocumentTemplatesSettingsPage />
              },
              {
                path: "/settings/clinical-documents",
                element: <RedirectWithSearch to="/configuracion/documentos-clinicos" />
              }
            ]
          },
          ...
          // Pacientes
          {
            ...
            children: [
              ...
              {
                path: "/patients/data-quality",
                element: <RedirectWithSearch to="/pacientes/calidad-datos" />
              }
            ]
          },
          {
          ...
          },
          {
            ...
            children: [
              ...
              {
                path: "/patients/configuration",
                element: <RedirectWithSearch to="/pacientes/configuracion" />
              },
              ...
              {
                path: "/patients/:id",
                element: <RedirectDynamicParam builder={(p, s) => `/pacientes/${p.id ?? ""}${s}`} />
              },
              {
                path: "/patients/:id/profile",
                element: <RedirectDynamicParam builder={(p, s) => `/pacientes/${p.id ?? ""}/perfil${s}`} />
              },
              {
                path: "/patients/:id/profile/benefits-coverages",
                element: (
                  <RedirectDynamicParam
                    builder={(p, s) => `/pacientes/${p.id ?? ""}/perfil/coberturas${s}`}
                  />
                )
              },
              {
                path: "/patients/:id/profile/comments",
                element: (
                  <RedirectDynamicParam
                    builder={(p, s) => `/pacientes/${p.id ?? ""}/perfil/comentarios${s}`}
                  />
                )
              },
              {
                path: "/patients/:id/profile/tasks",
                element: (
                  <RedirectDynamicParam builder={(p, s) => `/pacientes/${p.id ?? ""}/perfil/tareas${s}`} />
                )
              },
              {
                path: "/patients/:id/profile/emails",
                element: (
                  <RedirectDynamicParam builder={(p, s) => `/pacientes/${p.id ?? ""}/perfil/correos${s}`} />
                )
              },
              { path: "/patients/:id/crm", element: <RedirectPatientWithSearch to="perfil/tareas" /> },
              {
                path: "/patients/:id/treatments/new",
                element: (
                  <RedirectDynamicParam
                    builder={(p, s) => `/pacientes/${p.id ?? ""}/tratamientos/nuevo${s}`}
                  />
                )
              }
            ]
          },
          {
            ...
            children: [
              ...
              // Legacy
              {
                path: "/patients/:id/profile/appointments",
                element: (
                  <RedirectDynamicParam builder={(p, s) => `/pacientes/${p.id ?? ""}/perfil/citas${s}`} />
                )
              },
          ...
          },
          {
            ...
            children: [
              { path: "/pacientes/:id/tratamientos", element: <PatientTreatmentsPage /> },
              {
                ...
                element: (
                  <RedirectDynamicParam builder={(p, s) => `/pacientes/${p.id ?? ""}/tratamientos${s}`} />
                )
              }
            ]
          },
          {
            ...
            children: [
              ...
              // Legacy patient billing redirect
              {
                ...
                element: (
                  <RedirectDynamicParam builder={(p, s) => `/pacientes/${p.id ?? ""}/facturacion${s}`} />
                )
              }
            ]
          },
          {
            ...
            children: [
              { path: "/pacientes/:id/pagos", element: <PatientPaymentsPage /> },
              {
                ...
                element: <RedirectDynamicParam builder={(p, s) => `/pacientes/${p.id ?? ""}/pagos${s}`} />
              }
            ]
          },
          {
            ...
            children: [
              ...
              {
                path: "/pacientes/:id/archivos",
                element: <RedirectPatientWithSearch to="clinica/archivos" />
              },
              {
                path: "/patients/:id/clinical/files",
                element: (
                  <RedirectDynamicParam builder={(p, s) => `/pacientes/${p.id ?? ""}/clinica/archivos${s}`} />
                )
              },
          ...
          },
          {
            ...
            children: [
              ...
              {
                path: "/pacientes/:id/consentimientos",
                element: <RedirectPatientWithSearch to="clinica/consentimientos" />
              },
              {
                path: "/patients/:id/clinical/consents",
                element: (
                  <RedirectDynamicParam
                    builder={(p, s) => `/pacientes/${p.id ?? ""}/clinica/consentimientos${s}`}
                  />
                )
              },
              {
          ...
          },
          {
            ...
            children: [
              ...
              // Legacy clinical redirects
              {
                ...
                element: <RedirectDynamicParam builder={(p, s) => `/pacientes/${p.id ?? ""}/clinica${s}`} />
              },
              {
                path: "/patients/:id/clinical/history",
                element: (
                  <RedirectDynamicParam builder={(p, s) => `/pacientes/${p.id ?? ""}/clinica/historia${s}`} />
                )
              },
              {
                path: "/patients/:id/clinical/evolutions",
                element: (
                  <RedirectDynamicParam
                    builder={(p, s) => `/pacientes/${p.id ?? ""}/clinica/evoluciones${s}`}
                  />
                )
              },
              {
                path: "/patients/:id/clinical/medical-history",
                element: (
                  <RedirectDynamicParam
                    builder={(p, s) => `/pacientes/${p.id ?? ""}/clinica/anamnesis${s}`}
                  />
                )
              },
              {
                path: "/patients/:id/clinical/prescriptions",
                element: (
                  <RedirectDynamicParam builder={(p, s) => `/pacientes/${p.id ?? ""}/clinica/recetas${s}`} />
                )
              },
              {
                path: "/patients/:id/clinical/documents",
                element: (
                  <RedirectDynamicParam
                    builder={(p, s) => `/pacientes/${p.id ?? ""}/clinica/documentos${s}`}
                  />
                )
              },
              {
                path: "/patients/:id/clinical/odontogram",
                element: (
                  <RedirectDynamicParam
                    builder={(p, s) => `/pacientes/${p.id ?? ""}/clinica/odontograma${s}`}
                  />
                )
              },
              {
                path: "/patients/:id/clinical/periodontogram",
                element: (
                  <RedirectDynamicParam
                    builder={(p, s) => `/pacientes/${p.id ?? ""}/clinica/periodontograma${s}`}
                  />
                )
              }
            ]
          ...
          // Agenda
          {
            ...
            children: [
              ...
              { path: "/agenda/recordatorios", element: <AppointmentRemindersPage /> },
          ...
          // Pagos
          {
            ...
            children: [
              ...
              {
                path: "/payments/cancelled-pending",
                element: <RedirectWithSearch to="/pagos/anulados-pendientes" />
              }
            ]
          },
          {
          ...
          // Cajas
          {
            ...
            children: [
              ...
              {
                path: "/cash-register/:registerNumber",
                element: <RedirectDynamicParam builder={(p, s) => `/cajas/${p.registerNumber ?? ""}${s}`} />
              }
            ]
          },
          ...
          },
          {
            ...
            children: [
              ...
              {
                path: "/collections/:id",
                element: <RedirectDynamicParam builder={(p, s) => `/morosidad/${p.id ?? ""}${s}`} />
              }
            ]
          },
          ...
          // CRM
          {
            ...
            children: [
              ...
              {
                path: "/crm/surveys/:surveyId/edit",
                element: (
                  <RedirectDynamicParam builder={(p, s) => `/crm/encuestas/${p.surveyId ?? ""}/editar${s}`} />
                )
              },
              {
                path: "/crm/surveys/send-config",
                element: <RedirectWithSearch to="/crm/encuestas/configuracion-envio" />
              },
          ...
          },
          {
            ...
            children: [
              ...
              // Legacy
              {
                path: "/crm/email-marketing/reports",
                element: <RedirectWithSearch to="/crm/email-marketing/reportes" />
              },
              {
                path: "/crm/email-marketing/reports/:reportCode",
                element: (
                  <RedirectDynamicParam
                    builder={(p, s) => `/crm/email-marketing/reportes/${p.reportCode ?? ""}${s}`}
                  />
                )
              },
              {
                ...
                element: (
                  <RedirectDynamicParam
                    builder={(p, s) => `/crm/email-marketing/reportes/${p.reportCode ?? ""}/campana${s}`}
                  />
                )
              },
              {
                path: "/crm/email-marketing/campaigns",
                element: <RedirectWithSearch to="/crm/email-marketing/campanas" />
              },
              {
                path: "/crm/email-marketing/templates",
                element: <RedirectWithSearch to="/crm/email-marketing/plantillas" />
              },
              {
                path: "/crm/email-marketing/settings",
                element: <RedirectWithSearch to="/crm/email-marketing/configuracion" />
              }
            ]
          },
          {
          ...
          },
          {
            ...
            children: [
              ...
              {
                path: "/settings/users/blocks/access",
                element: <RedirectWithSearch to="/configuracion/usuarios/bloqueos/acceso" />
              }
            ]
          },
          {
            ...
            children: [
              ...
              {
                path: "/settings/users/blocks/agenda",
                element: <RedirectWithSearch to="/configuracion/usuarios/bloqueos/agenda" />
              }
            ]
          },
          {
            ...
            children: [
              ...
              {
                path: "/settings/users/contracts/bulk",
                element: <RedirectWithSearch to="/configuracion/usuarios/contratos/masivos" />
              }
            ]
          },
          {
            ...
            children: [
              ...
              { path: "/settings/roles", element: <RedirectWithSearch to="/configuracion/roles" /> },
              {
                ...
                element: <RedirectWithSearch to="/configuracion/usuarios/perfiles" />
              },
              {
                path: "/settings/roles/:id",
                element: <RedirectDynamicParam builder={(p, s) => `/configuracion/roles/${p.id ?? ""}${s}`} />
              }
            ]
          }
        ]
