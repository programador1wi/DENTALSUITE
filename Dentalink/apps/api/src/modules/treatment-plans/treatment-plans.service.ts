...
export class TreatmentPlansService {
  constructor(
    ...
    private readonly budgetsService?: TreatmentPlanBudgetsService,
    private readonly printService?: TreatmentPlanPrintService
  ) {}

  private get budgets(): TreatmentPlanBudgetsService {
    return (
      this.budgetsService ??
      new TreatmentPlanBudgetsService(this.prisma, this.crmTasksService)
    );
  }

  private get print(): TreatmentPlanPrintService {
    return this.printService ?? new TreatmentPlanPrintService(this.prisma);
  }
  ...
  async createBudget(actor: AuthUser, treatmentPlanId: string, dto: CreateBudgetDto) {
    return this.budgets.createBudget(actor, treatmentPlanId, dto);
  }
  ...
  async printTreatmentPlanDocument(
    ...
    return this.print.printTreatmentPlanDocument(actor, id, dto, mode);
  }
