...
export async function listTreatmentPlans(params?: { patientId?: string; branchId?: string; professionalId?: string; status?: TreatmentPlanStatus }) {
...
export async function addTreatmentPlanSection(treatmentPlanId: string, payload: { name: string; sortOrder?: number }) {
  const { data } = await http.post<TreatmentPlanDetail>(`/treatment-plans/${treatmentPlanId}/sections`, payload);
  return data;
}
...
export async function updateTreatmentPlanItem(treatmentPlanId: string, itemId: string, payload: TreatmentPlanItemPayload) {
  const { data } = await http.patch<TreatmentPlanDetail>(`/treatment-plans/${treatmentPlanId}/items/${itemId}`, payload);
  return data;
}

export async function deleteTreatmentPlanItem(treatmentPlanId: string, itemId: string) {
  const { data } = await http.delete<{ success: boolean }>(`/treatment-plans/${treatmentPlanId}/items/${itemId}`);
  return data;
}
...
export async function listBudgets(params?: { patientId?: string; treatmentPlanId?: string; status?: BudgetStatus }) {
...
export async function createBudget(treatmentPlanId: string, payload: { discountTotal?: number; expiresAt?: string; notes?: string }) {
