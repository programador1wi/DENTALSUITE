...
export const navItems: MainNavItem[] = [
  ...
  { to: "/cash-register/open", label: "Cajas", icon: WalletCards, permission: "cash_register.read" },
  {
    ...
    children: [
      ...
      },
      {
        ...
        permission: "payment_settlements.read",
        icon: Landmark
      },
  ...
  },
  {
    ...
    children: [
      ...
      {
        to: "/patients/data-quality",
        label: "Identidad de pacientes",
        permission: "patient_duplicates.review",
        section: "administration",
        icon: ShieldCheck
      },
      {
      ...
      {
        to: "/settings/clinical-documents",
        label: "Documentos clinicos",
        permission: ["clinical.read", "clinical.templates.manage"],
        section: "configuration",
        icon: FileText
      },
      {
        to: "/settings/consent-templates",
        label: "Consentimientos informados",
        permission: "consent_templates.read",
        section: "configuration",
        icon: FileCheck
      },
      {
  ...
  {
    to: "/crm/email-marketing",
    label: "CRM",
    icon: Handshake,
    permission: "integrations.communications.read",
    children: [
      { to: "/crm/email-marketing", label: "Email Marketing", permission: "integrations.communications.read", icon: Mail },
      { to: "/crm/surveys", label: "Encuestas de satisfacción", permission: "integrations.surveys.read", icon: FileCheck },
      { to: "/patients", label: "Tareas de gestión", permission: "patients.tasks.read", icon: ClipboardList }
    ]
  }
];
